...
module.exports = {
  ...
  var songInfo = video
   ...
   const queueConstruct = {
    ...
    if (!song){
      if (!online.afk) {
        sendError("Leaving the voice channel because I think there are no songs in the queue. If you like the bot stay 24/7 in voice channel run `m.afk`\n\n MRX! [MRX YOUTUBE](https://www.youtube.com/channel/UCaEq12wYATpEIZvD6-K7IXA) [MRX DISCORD](https://discord.gg/ZTtj4f6ctA)", message.channel)
